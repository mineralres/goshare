...
// Ready 是否准备好
func (c *ExternClient) Ready() bool {
	return c.ready
}

// Server Server
func (c *ExternClient) Server() string {
	return c.server
}

// ConnectAndJoin 连接
func (c *ExternClient) ConnectAndJoin(address string, hf func(), autoReconnect bool) {
	if c.retryTimes > 20 {
...
// Close 关机
func (c *ExternClient) Close() {
	c.chOut <- make([]byte, 0)
}

func (c *ExternClient) setup() {
	c.chOut <- exSetupCmd1
}

func (c *ExternClient) read(conn net.Conn) {
	defer conn.Close()
	for {
...
func (c *ExternClient) send(pkg []byte) {
	c.chOut <- pkg
}

func (c *ExternClient) handleMessage(h *header, body []byte) {
	b, _ := json.Marshal(h)
...
func (c *ExternClient) GetInstrumentCount() {
	// 前四个字段等于F2 小端
...
func (c *ExternClient) ReqGetMarkets() {
	c.chOut <- exGetMarketsCmd
}

// GetInstrumentBars 查询K线
func (c *ExternClient) GetInstrumentBars(req *ReqGetInstrumentBars, requestID int64, h func([]TdxKline, int64)) error {
	var err error
	defer func() {
		if err != nil && h != nil {
			h(nil, requestID)
...
func (c *ExternClient) onRspGetInstrumentBars(h *header, body []byte) {
	c.requestQueueLock.Lock()
	if len(c.requestQueue) == 0 {
		panic("len(c.requestQueue) == 0")
	}
...
func (c *ExternClient) GetInstrumentQuote(req *ReqGetInstrumentQuote) {
	cmd := []byte{0x01, 0x01, 0x08, 0x02, 0x02, 0x01, 0x0c, 0x00, 0x0c, 0x00, 0xfa, 0x23}
	cmd = append(cmd, marshal(req)...)
	c.chOut <- cmd
}

func (c *ExternClient) onRspGetInstrumentQuote(h *header, body []byte) {
...
func (c *ExternClient) GetInstrumentInfo(start uint32, count uint16) {
...
func (c *ExternClient) onRspGetInstrumentInfo(h *header, body []byte) {
	var req ReqGetInstrumentInfo
	unmarshal(body, &req)
	pos := 6
...
func (c *ExternClient) GetInstrumentQuoteList(market uint8, category uint8, start uint32, count uint16) {

}

// GetMinuteTimeData 查询分时数据
func (c *ExternClient) GetMinuteTimeData(market uint8, code string) {
...
func (c *ExternClient) onRspGetMinuteTimeData(h *header, body []byte) {
...
func (c *ExternClient) GetHistoryMinuteTimeData(market uint8, code string, date uint32) {
...
func (c *ExternClient) onRspGetHistoryMinuteTimeData(h *header, body []byte) {
...
func (c *ExternClient) GetTransactionData(market uint8, code string, start int32, count uint16) {
...
func (c *ExternClient) onRspGetTransactionData(h *header, body []byte) {
...
func (c *ExternClient) GetHistoryTransactionData(date uint32, market uint8, code string, start int32, count uint16) {
...
func (c *ExternClient) onRspGetHistoryTransactionData(h *header, body []byte) {
	var rsp RspGetTransactionDataHeader
	err := unmarshal(body, &rsp)
	if err != nil {
		log.Println(err)
