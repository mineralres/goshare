...
func (db *XLevelDB) GetTradingInstrument(s *pb.Symbol) (*pb.TradingInstrument, error) {
...
func (db *XLevelDB) TradingInstrumentList() []*pb.TradingInstrument {
...
// GetTick GetTick
func (db *XLevelDB) GetTick(req *pb.Symbol) (*pb.MarketDataSnapshot, error) {
