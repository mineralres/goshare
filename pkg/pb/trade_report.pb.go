...
func (OrderHedgeType) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (TradeType) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (*TradeReport) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*TradeReportList) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (*TradeReportSession) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func init() { proto.RegisterFile("trade_report.proto", fileDescriptor11) }
