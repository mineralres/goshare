...
func (BindingMessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_000a540d8ea256f1, []int{0}
}
...
func init() { proto.RegisterFile("binding.proto", fileDescriptor_000a540d8ea256f1) }

var fileDescriptor_000a540d8ea256f1 = []byte{
