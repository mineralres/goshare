...
func (*NetInAmountDetail) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*RealtimeMoneyTrendItem) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*RealtimeMoneyTrendItemList) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func init() { proto.RegisterFile("others.proto", fileDescriptor4) }
