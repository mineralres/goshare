...
inline void HttpRule::clear_response_body() {
  response_body_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
...
inline void HttpRule::set_response_body(const std::string& value) {
  ...
  response_body_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
...
inline void HttpRule::set_response_body(const char* value) {
  ...
  response_body_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
...
inline void HttpRule::set_response_body(const char* value,
  ...
  response_body_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
...
inline std::string* HttpRule::mutable_response_body() {
  ...
  return response_body_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline std::string* HttpRule::release_response_body() {
  // @@protoc_insertion_point(field_release:google.api.HttpRule.response_body)
  
  return response_body_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
